...
Mallet expects a file containing stopwords which are removed from the corpus and this package contains a file with english stopwords taken from \url{http://www.ranks.nl/stopwords}. The first step is to create mallet instances of your corpus that can be used by topic models provided by mallet. Then create the topic model of your choice, in this case we use latent dirichlet allocation (LDA), and load the mallet instances into it.
